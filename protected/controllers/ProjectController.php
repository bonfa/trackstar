...
class ProjectController extends Controller
{
	...
	public function actionView($id)
	{
		...
		//Provides the list of the issues related to the current project
		...
		Yii::app()->clientScript->registerLinkTag('alternate', 'application/rss+xml', $this->createUrl('comment/feed', array('pid'=>$this->id)));
	...
	public function actionAddUser($id) {
		...
		if(isset($_POST['ProjectUserForm'])) {
			...
			//validate user input and set a successful message if valid
			if($form->validate()){
